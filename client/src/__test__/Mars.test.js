//Create response object with data for mars
...
//import mars , react, and other dependencies
...
it('Renders mars part of application and checks elements', () => {
  ...
  expect(screen.getByText(nasaResponse.photos[0].earth_date)).toBeInTheDocument();
});
